/*
Q--> Find the number of ways to reach the ending cell from the starting cell where some cells are blocked(the ones contain in gthe character '#).
(Provided that the satrting and the ending cells are not the blocked cells.)
*/
#include<bits/stdc++.h>
using namespace std;
